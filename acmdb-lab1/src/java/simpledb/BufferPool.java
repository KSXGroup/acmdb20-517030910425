...
public class BufferPool {
    ...
    private static class Node{
        ...
        public Node(PageId pageId, Page page, Node prev, Node next){
            this.page = page;
            this.prev = prev;
            this.next = next;
        }

        public void setPage(PageId pageId, Page page){
            this.page = page;
        }
    }
    ...
    private static class LRUCache{
        ...
        public synchronized boolean put(PageId pageId, Page page){
            if(this.pageMap.containsKey(pageId)){
                ...
                if (this.numPages == this.maxPages) {
                    n = removeTail();
                    n.setPage(pageId, page);
                }
                else {
                    n = new Node(pageId, page, null, null);
                    this.numPages += 1;
                }
                insertAtBeginning(n);
        ...
        public synchronized boolean remove(PageId pageId){
            if(this.pageMap.containsKey(pageId)){
    ...
    public  Page getPage(TransactionId tid, PageId pid, Permissions perm)
        ...
        if(this.lruCache.contains(pid)){
            ...
            if(lruCache.put(pid, newPage))
                return newPage;
            else
                throw new DbException("Can not put the LRU Cache!");
        }
    }
